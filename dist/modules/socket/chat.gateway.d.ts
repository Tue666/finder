...
export declare class ChatGateway implements OnGatewayConnection, OnGatewayDisconnect, OnGatewayInit {
    ...
    constructor(userService: UserService, cacheManager: Cache, loggerService: LoggerService, messageService: MessageService, socketService: SocketService, conversationService: ConversationService);
    server: Server;
    ...
    sendMessage(data: MessageInput, user: User): Promise<Message>;
